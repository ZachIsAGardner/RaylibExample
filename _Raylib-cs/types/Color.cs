...
public partial struct Color
{
    ...
    public Color WithAlpha(float? alpha) => alpha != null ? new Color(R, G, B, (byte)(Math.Max(0, alpha.Value) * 255)) : this;
    ...
    {
        if (String.IsNullOrWhiteSpace(hex)) return new Color(255, 255, 255);
